...
// Check if user is logged in and is EDUC student
if (!isset($_SESSION['user_id']) || $_SESSION['course'] != 'EDUC') {
...
<head>
    ...
    <title>BSED Server • College of Education</title>
    ...
    <style>
        * {
        ...
        :root {
            --educ-blue: #3498DB;
            --educ-blue-dark: #2980B9;
            --educ-blue-light: #7FBCEB;
            --educ-blue-pale: #EBF5FF;
            ...
            --card-shadow: 0 20px 40px -10px rgba(52, 152, 219, 0.15);
            --hover-shadow: 0 30px 50px -12px rgba(52, 152, 219, 0.25);
        ...
        ::-webkit-scrollbar-thumb {
            background: var(--educ-blue);
            border-radius: 10px;
            border: 2px solid #f1f1f1;
        }

        ::-webkit-scrollbar-thumb:hover {
            background: var(--educ-blue-dark);
        }
        ...
        .brand-icon {
            width: 48px;
            height: 48px;
            background: linear-gradient(135deg, var(--educ-blue), var(--educ-blue-dark));
            border-radius: 14px;
            display: flex;
            align-items: center;
        ...
        /* Welcome Banner */
        .welcome-banner {
            background: linear-gradient(105deg, white 0%, white 50%, #EBF5FF 100%);
            border-radius: 30px;
            padding: 40px;
            margin-bottom: 30px;
        ...
        .kpi-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--educ-blue), var(--educ-blue-light));
        }
        ...
        .status-dot {
            ...
            background: var(--educ-blue);
            border-radius: 50%;
            box-shadow: 0 0 10px var(--educ-blue);
        ...
        .progress-fill {
            height: 100%;
            background: linear-gradient(90deg, var(--educ-blue), var(--educ-blue-dark));
            border-radius: 5px;
        ...
        .access-server:hover {
            ...
            background: linear-gradient(135deg, var(--educ-blue-dark), var(--educ-blue));
        }
        ...
        .facility-card {
            ...
            transition: all 0.3s;
            border-left: 6px solid var(--educ-blue);
            position: relative;
            overflow: hidden;
            border: 1px solid #e0e0e0;
        }
        ...
        .badge-active { background: #EBF5FF; color: var(--educ-blue); }
        ...
        .loading-spinner {
            ...
            border-top: 3px solid var(--educ-blue);
            border-radius: 50%;
