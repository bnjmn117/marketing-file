...
// Check if user is logged in and is CRIM student
if (!isset($_SESSION['user_id']) || $_SESSION['course'] != 'CRIM') {
...
<head>
    ...
    <title>BSCRIM Server • College of Criminology</title>
    ...
    <style>
        * {
        ...
        :root {
            --crim-red: #E74C3C;
            --crim-red-dark: #C0392B;
            --crim-red-light: #F1948A;
            --crim-red-pale: #FDEDEC;
            ...
            --card-shadow: 0 20px 40px -10px rgba(231, 76, 60, 0.15);
            --hover-shadow: 0 30px 50px -12px rgba(231, 76, 60, 0.25);
        ...
        .brand-icon {
            width: 48px;
            height: 48px;
            background: linear-gradient(135deg, var(--crim-red), var(--crim-red-dark));
            border-radius: 14px;
            display: flex;
            align-items: center;
        ...
        /* Welcome Banner */
        .welcome-banner {
            background: linear-gradient(105deg, white 0%, white 50%, #FDEDEC 100%);
            border-radius: 30px;
            padding: 40px;
            margin-bottom: 30px;
        ...
        .kpi-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--crim-red), var(--crim-red-light));
        }
        ...
        .status-dot {
            ...
            background: var(--crim-red);
            border-radius: 50%;
            box-shadow: 0 0 10px var(--crim-red);
        ...
        .progress-fill {
            height: 100%;
            background: linear-gradient(90deg, var(--crim-red), var(--crim-red-dark));
            border-radius: 5px;
        ...
        .access-server:hover {
            ...
            background: linear-gradient(135deg, var(--crim-red-dark), var(--crim-red));
        }
        ...
        .facility-card {
            ...
            transition: all 0.3s;
            border-left: 6px solid var(--crim-red);
            position: relative;
            overflow: hidden;
            border: 1px solid #e0e0e0;
        }
        ...
        .badge-active { background: #FDEDEC; color: var(--crim-red); }
        ...
        .loading-spinner {
            ...
            border-top: 3px solid var(--crim-red);
            border-radius: 50%;
