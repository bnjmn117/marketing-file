...
// Check if user is logged in and is OAD student
if (!isset($_SESSION['user_id']) || $_SESSION['course'] != 'OAD') {
...
<head>
    ...
    <title>BSOA Server • Office Administration</title>
    ...
    <style>
        * {
        ...
        :root {
            --oad-purple: #9B59B6;
            --oad-purple-dark: #8E44AD;
            --oad-purple-light: #C39BD3;
            --oad-purple-pale: #F4ECF7;
        ...
        ::-webkit-scrollbar-thumb {
            background: var(--oad-purple);
            border-radius: 10px;
            border: 2px solid #f1f1f1;
        }

        ::-webkit-scrollbar-thumb:hover {
            background: var(--oad-purple-dark);
        }
        ...
        .brand-icon {
            width: 48px;
            height: 48px;
            background: linear-gradient(135deg, var(--oad-purple), var(--oad-purple-dark));
            border-radius: 14px;
            display: flex;
            align-items: center;
        ...
        .kpi-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--oad-purple), var(--oad-purple-light));
        }
        ...
        .status-dot {
            ...
            background: var(--oad-purple);
            border-radius: 50%;
            box-shadow: 0 0 10px var(--oad-purple);
        ...
        .progress-fill {
            height: 100%;
            background: linear-gradient(90deg, var(--oad-purple), var(--oad-purple-dark));
            border-radius: 5px;
        ...
        .access-server:hover {
            ...
            background: linear-gradient(135deg, var(--oad-purple-dark), var(--oad-purple));
        }
        ...
        .office-item {
            ...
            border-radius: 15px;
            text-align: center;
            border-left: 4px solid var(--oad-purple);
        }
        ...
        .skill-tag {
            ...
            border-radius: 20px;
            font-size: 0.8rem;
            border: 1px solid var(--oad-purple);
            display: inline-block;
            margin: 2px;
        }
        ...
        .facility-card {
            ...
            transition: all 0.3s;
            border-left: 6px solid var(--oad-purple);
            position: relative;
            overflow: hidden;
            border: 1px solid #e0e0e0;
        }
        ...
        .badge-active { background: #F4ECF7; color: var(--oad-purple); }
        ...
        .loading-spinner {
            ...
            border-top: 3px solid var(--oad-purple);
            border-radius: 50%;
...
<body>
    <div class="enterprise-dashboard">
        ...
        <!-- OAD Office Skills Section -->
        <div class="server-grid-section">
            <div class="section-header">
                <div class="section-title">
                    <i>📝</i>
                    <h2>Office Skills & Competencies</h2>
                </div>
                <div class="section-badge">OAD Core</div>
            </div>

            <div class="office-grid">
                <div class="office-item">
                    <h4>Typing Proficiency</h4>
                    <p>Target: 65 WPM</p>
                    <p>Current: 58 WPM</p>
                    <div style="margin-top: 10px;">
                        <span class="skill-tag">Speed</span>
                        <span class="skill-tag">Accuracy</span>
                    </div>
                </div>
                <div class="office-item">
                ...
                <div class="office-item">
                    ...
                    <p>Memos, Letters, Reports</p>
                    <p>Professional Writing</p>
                    <div style="margin-top: 10px;">
                        <span class="skill-tag">Correspondence</span>
                    </div>
                </div>
                <div class="office-item">
                    <h4>Bookkeeping</h4>
        ...
        <div class="server-grid-section">
            <div class="section-header">
                ...
                <div class="section-badge">Recent Tasks</div>
            </div>

            <div class="document-grid">
                <div class="document-item">
                    <i class="fas fa-file-word"></i>
                    <span>Business Correspondence - Memo Draft</span>
                </div>
                <div class="document-item">
                    <i class="fas fa-file-excel"></i>
                    <span>Financial Report - Q1 2024</span>
                </div>
                <div class="document-item">
                    <i class="fas fa-file-powerpoint"></i>
                    <span>Office Presentation - Meeting</span>
                </div>
                <div class="document-item">
                    <i class="fas fa-file-pdf"></i>
                    <span>Records Manual - Updated</span>
                </div>
                <div class="document-item">
