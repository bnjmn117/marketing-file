...
// Check if user is logged in and is HM student
if (!isset($_SESSION['user_id']) || $_SESSION['course'] != 'HM') {
...
<head>
    ...
    <title>HM Server • Hospitality Management</title>
    ...
    <style>
        * {
        ...
        :root {
            --hm-orange: #E67E22;
            --hm-orange-dark: #D35400;
            --hm-orange-light: #F0B27A;
            --hm-orange-pale: #FEF5E7;
        ...
        .kpi-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--hm-orange), var(--hm-orange-light));
        }
        ...
        .status-dot {
            ...
            background: var(--hm-orange);
            border-radius: 50%;
            box-shadow: 0 0 10px var(--hm-orange);
        ...
        .access-server:hover {
            ...
            background: linear-gradient(135deg, var(--hm-orange-dark), var(--hm-orange));
        }
        ...
        .badge-active { background: #FEF5E7; color: var(--hm-orange); }
...
<body>
    <div class="enterprise-dashboard">
        ...
        <!-- HM Kitchen Lab Schedule -->
        <div class="server-grid-section">
            <div class="section-header">
                <div class="section-title">
                    <i>🍳</i>
                    <h2>Kitchen Laboratory Schedule</h2>
                </div>
            ...
            <div class="kitchen-grid">
                <div class="kitchen-item">
                    <h4>Hot Kitchen</h4>
                    <p>Chef Miguel Santos</p>
                    <p>Monday, Wednesday, Friday</p>
                    <p>8:00 AM - 11:00 AM</p>
                    <div style="margin-top: 10px;">
                        <span class="menu-tag">Menu Planning</span>
                        <span class="menu-tag">Cooking Techniques</span>
                    </div>
                </div>
                <div class="kitchen-item">
                    <h4>Cold Kitchen</h4>
                    ...
                    <p>1:00 PM - 4:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="menu-tag">Salads</span>
                        <span class="menu-tag">Appetizers</span>
                        <span class="menu-tag">Plating</span>
                    </div>
                </div>
                <div class="kitchen-item">
                    <h4>Pastry & Baking</h4>
                    ...
                    <p>1:00 PM - 4:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="menu-tag">Breads</span>
                        <span class="menu-tag">Pastries</span>
                        <span class="menu-tag">Desserts</span>
                    </div>
                </div>
                <div class="kitchen-item">
                    <h4>Bartending</h4>
                    ...
                    <p>4:00 PM - 7:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="menu-tag">Mixology</span>
                        <span class="menu-tag">Wine Service</span>
                    </div>
                </div>
                <div class="kitchen-item">
                    ...
                    <div style="margin-top: 10px;">
                        <span class="menu-tag">Front of House</span>
                        <span class="menu-tag">Service Etiquette</span>
                    </div>
                </div>
                <div class="kitchen-item">
                    <h4>Food Safety</h4>
                    <p>Chef Robert Gomez</p>
                    <p>Wednesday</p>
                    <p>8:00 AM - 12:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="menu-tag">Sanitation</span>
                        <span class="menu-tag">HACCP</span>
                    </div>
                </div>
            </div>
        </div>
