...
if (!isset($_SESSION['loading_shown'])) {
    ...
    $_SESSION['loading_course'] = 'TECHVOC';
...
// Check if user is logged in and is TECHVOC student
if (!isset($_SESSION['user_id']) || $_SESSION['course'] != 'TECHVOC') {
...
<head>
    ...
    <title>TECHVOC Server • Technical-Vocational Livelihood</title>
    ...
    <style>
        * {
        ...
        :root {
            --techvoc-orange: #E67E22;
            --techvoc-orange-dark: #D35400;
            --techvoc-orange-light: #F0B27A;
            --techvoc-orange-pale: #FEF5E7;
            ...
            --card-shadow: 0 20px 40px -10px rgba(230, 126, 34, 0.15);
            --hover-shadow: 0 30px 50px -12px rgba(230, 126, 34, 0.25);
        ...
        ::-webkit-scrollbar-thumb {
            background: var(--techvoc-orange);
            border-radius: 10px;
            border: 2px solid #f1f1f1;
        }

        ::-webkit-scrollbar-thumb:hover {
            background: var(--techvoc-orange-dark);
        }
        ...
        .brand-icon {
            width: 48px;
            height: 48px;
            background: linear-gradient(135deg, var(--techvoc-orange), var(--techvoc-orange-dark));
            border-radius: 14px;
            display: flex;
            align-items: center;
        ...
        .logout-btn:hover {
            background: var(--techvoc-orange);
            border-color: var(--techvoc-orange);
            color: white;
        ...
        /* Welcome Banner */
        .welcome-banner {
            background: linear-gradient(105deg, white 0%, white 50%, #FEF5E7 100%);
            border-radius: 30px;
            padding: 40px;
            margin-bottom: 30px;
        ...
        .stat-circle {
            ...
            font-size: 24px;
            color: var(--techvoc-orange);
            box-shadow: 0 8px 16px rgba(230, 126, 34, 0.1);
        }
        ...
        .kpi-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--techvoc-orange), var(--techvoc-orange-light));
        }
        ...
        .status-dot {
            ...
            background: var(--techvoc-orange);
            border-radius: 50%;
            box-shadow: 0 0 10px var(--techvoc-orange);
        ...
        .progress-fill {
            height: 100%;
            background: linear-gradient(90deg, var(--techvoc-orange), var(--techvoc-orange-dark));
            border-radius: 5px;
        ...
        .access-server:hover {
            ...
            background: linear-gradient(135deg, var(--techvoc-orange-dark), var(--techvoc-orange));
        }
        ...
        .workshop-item {
            ...
            border-radius: 15px;
            text-align: center;
            border-left: 4px solid var(--techvoc-orange);
        }
        ...
        .skill-tag {
            ...
            border-radius: 20px;
            font-size: 0.8rem;
            border: 1px solid var(--techvoc-orange);
            display: inline-block;
            margin: 2px;
        }
        ...
        .facility-card {
            ...
            transition: all 0.3s;
            border-left: 6px solid var(--techvoc-orange);
            position: relative;
            overflow: hidden;
            border: 1px solid #e0e0e0;
        }
        ...
        .badge-active { background: #FEF5E7; color: var(--techvoc-orange); }
        .badge-tesda { background: #27AE60; color: white; }
        ...
        .loading-spinner {
            ...
            border-top: 3px solid var(--techvoc-orange);
            border-radius: 50%;
...
<body>
    <div class="enterprise-dashboard">
        ...
        <!-- TECHVOC Workshop Schedule -->
        <div class="server-grid-section">
            <div class="section-header">
                <div class="section-title">
                    <i>🔧</i>
                    <h2>Workshop & Laboratory Schedule</h2>
                </div>
                <div class="section-badge">TESDA Accredited</div>
            </div>

            <div class="workshop-grid">
                <div class="workshop-item">
                    <h4>Automotive Servicing</h4>
                    <p>Instr. Miguel Santos</p>
                    <p>Monday, Wednesday, Friday</p>
                    <p>8:00 AM - 11:00 AM</p>
                    <div style="margin-top: 10px;">
                        <span class="certification-badge">NC II</span>
                        <span class="skill-tag">Engine Repair</span>
                        <span class="skill-tag">Diagnostics</span>
                    </div>
                </div>
                <div class="workshop-item">
                    <h4>Electronics</h4>
                    <p>Instr. Anna Reyes</p>
                    <p>Tuesday, Thursday</p>
                    <p>1:00 PM - 4:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="certification-badge">NC II</span>
                        <span class="skill-tag">Circuit Board</span>
                        <span class="skill-tag">Troubleshooting</span>
                    </div>
                </div>
                <div class="workshop-item">
                    <h4>Cookery</h4>
                    <p>Instr. Maria Cruz</p>
                    <p>Monday, Wednesday</p>
                    <p>1:00 PM - 4:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="certification-badge">NC II</span>
                        <span class="skill-tag">Food Prep</span>
                        <span class="skill-tag">Kitchen Management</span>
                    </div>
                </div>
                <div class="workshop-item">
                    <h4>Bread & Pastry</h4>
                    ...
                    <div style="margin-top: 10px;">
                        <span class="certification-badge">NC II</span>
                        <span class="skill-tag">Baking</span>
                        <span class="skill-tag">Pastry Arts</span>
                    </div>
                </div>
                <div class="workshop-item">
                    <h4>Welding</h4>
                    <p>Instr. Robert Gomez</p>
                    <p>Thursday, Friday</p>
                    <p>1:00 PM - 4:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="certification-badge">NC I</span>
                        <span class="skill-tag">SMAW</span>
                        <span class="skill-tag">GMAW</span>
                    </div>
                </div>
                <div class="workshop-item">
        ...
        <div class="server-grid-section">
            <div class="section-header">
                <div class="section-title">
                    <i>⚙️</i>
                    <h2>Ongoing Projects & Assessments</h2>
                </div>
                <div class="section-badge">NC II Assessments</div>
            </div>

            <div class="project-grid">
                <div class="project-item">
                    <div class="project-title">Engine Overhaul Project</div>
                    <div>Automotive - Group 3</div>
                    <div class="project-status">
                        <span>Due: March 25, 2024</span>
                        <span>NC II Assessment</span>
                    </div>
                ...
                <div class="project-item">
                    <div class="project-title">Amplifier Circuit Assembly</div>
                    <div>Electronics - Group 1</div>
                    <div class="project-status">
                        <span>Due: March 22, 2024</span>
                        <span>NC II Assessment</span>
                    </div>
                    <div class="project-progress">
                ...
                <div class="project-item">
                    <div class="project-title">3-Course Meal Preparation</div>
                    <div>Cookery - Individual</div>
                    <div class="project-status">
                ...
                <div class="project-item">
                    <div class="project-title">Wedding Cake Design</div>
                    <div>Bread & Pastry - Group 2</div>
                    <div class="project-status">
                        <span>Due: March 28, 2024</span>
                        <span>NC II Assessment</span>
                    </div>
                    <div class="project-progress">
            ...
            <div class="facilities-grid">
                ...
                <div class="facility-card">
                    <div class="facility-header">
                        <span class="facility-name">TECHVOC Facilities</span>
                        <span class="facility-badge badge-tesda">TESDA Accredited</span>
                    </div>
                    <div class="facility-metrics">
                        ...
                        <div class="metric-item">
                            ...
                            <div class="metric-label">NC II Programs</div>
                        </div>
                    </div>
                    <ul class="facility-features">
                        <li><i class="fas fa-car"></i> Automotive Shop</li>
                        <li><i class="fas fa-microchip"></i> Electronics Lab</li>
                        <li><i class="fas fa-utensils"></i> Kitchen Lab</li>
                        <li><i class="fas fa-tools"></i> Welding Shop</li>
                    </ul>
                </div>
