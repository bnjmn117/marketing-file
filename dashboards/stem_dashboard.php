...
// Check if user is logged in and is STEM student
if (!isset($_SESSION['user_id']) || $_SESSION['course'] != 'STEM') {
...
<head>
    ...
    <title>STEM Server • Science, Technology, Engineering & Mathematics</title>
    ...
    <style>
        * {
        ...
        :root {
            --stem-teal: #1ABC9C;
            --stem-teal-dark: #16A085;
            --stem-teal-light: #6DD5B8;
            --stem-teal-pale: #E8F8F5;
            ...
            --card-shadow: 0 20px 40px -10px rgba(26, 188, 156, 0.15);
            --hover-shadow: 0 30px 50px -12px rgba(26, 188, 156, 0.25);
        ...
        .brand-icon {
            width: 48px;
            height: 48px;
            background: linear-gradient(135deg, var(--stem-teal), var(--stem-teal-dark));
            border-radius: 14px;
            display: flex;
            align-items: center;
        ...
        /* Welcome Banner */
        .welcome-banner {
            background: linear-gradient(105deg, white 0%, white 50%, #E8F8F5 100%);
            border-radius: 30px;
            padding: 40px;
            margin-bottom: 30px;
        ...
        .kpi-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, var(--stem-teal), var(--stem-teal-light));
        }
        ...
        .status-dot {
            ...
            background: var(--stem-teal);
            border-radius: 50%;
            box-shadow: 0 0 10px var(--stem-teal);
        ...
        .progress-fill {
            height: 100%;
            background: linear-gradient(90deg, var(--stem-teal), var(--stem-teal-dark));
            border-radius: 5px;
        ...
        .access-server:hover {
            ...
            box-shadow: 0 15px 25px rgba(26, 188, 156, 0.3);
            background: linear-gradient(135deg, var(--stem-teal-dark), var(--stem-teal));
        }
        ...
        .lab-item {
            ...
            border-radius: 15px;
            text-align: center;
            border-left: 4px solid var(--stem-teal);
        }
        ...
        .formula-tag {
            ...
            border-radius: 20px;
            font-size: 0.8rem;
            border: 1px solid var(--stem-teal);
            display: inline-block;
            margin: 2px;
        ...
        .facility-card {
            ...
            transition: all 0.3s;
            border-left: 6px solid var(--stem-teal);
            position: relative;
            overflow: hidden;
            border: 1px solid #e0e0e0;
        }
        ...
        .badge-active { background: #E8F8F5; color: var(--stem-teal); }
    ...
    <div class="enterprise-dashboard">
        ...
        <div class="server-grid-section">
            ...
            <div class="lab-grid">
                <div class="lab-item">
                    <h4>Physics Lab</h4>
                    <p>Dr. Michael Santos</p>
                    <p>Monday, Wednesday</p>
                    <p>8:00 AM - 11:00 AM</p>
                    <div style="margin-top: 10px;">
                        <span class="formula-tag">F = ma</span>
                        <span class="formula-tag">E = mc²</span>
                    </div>
                </div>
                <div class="lab-item">
                    <h4>Chemistry Lab</h4>
                    ...
                    <p>1:00 PM - 4:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="formula-tag">H₂O</span>
                        <span class="formula-tag">pH</span>
                    </div>
                </div>
                <div class="lab-item">
                    <h4>Biology Lab</h4>
                    ...
                    <div style="margin-top: 10px;">
                        <span class="formula-tag">DNA</span>
                        <span class="formula-tag">Cell</span>
                    </div>
                </div>
                <div class="lab-item">
                    ...
                    <p>1:00 PM - 3:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="formula-tag">∫x²dx</span>
                        <span class="formula-tag">Σ</span>
                    </div>
                </div>
                <div class="lab-item">
                    <h4>Engineering Lab</h4>
                    <p>Engr. Lisa Wong</p>
                    <p>Tuesday, Friday</p>
                    <p>10:00 AM - 1:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="formula-tag">F=ma</span>
                        <span class="formula-tag">Torque</span>
                    </div>
                </div>
                <div class="lab-item">
                    <h4>Computer Lab</h4>
                    <p>Prof. Robert Gomez</p>
                    <p>Wednesday</p>
                    <p>1:00 PM - 4:00 PM</p>
                    <div style="margin-top: 10px;">
                        <span class="formula-tag">Python</span>
                        <span class="formula-tag">Java</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="server-grid-section">
            <div class="section-header">
                ...
                <div class="section-badge">Due This Week</div>
            </div>

            <div class="experiment-grid">
                <div class="experiment-item">
                    <div class="experiment-title">Projectile Motion</div>
                    <div>Physics 101 - Dr. Santos</div>
                    <div class="experiment-date">Due: March 20, 2024</div>
                    <div style="margin-top: 8px;">
                        <span class="equipment-tag">Launcher</span>
                        <span class="equipment-tag">Timer</span>
                        <span class="equipment-tag">Meter Stick</span>
                    </div>
                </div>
                <div class="experiment-item">
                    <div class="experiment-title">Titration</div>
                    <div>Chemistry 101 - Dr. Reyes</div>
                    <div class="experiment-date">Due: March 22, 2024</div>
                    <div style="margin-top: 8px;">
                        <span class="equipment-tag">Burette</span>
                        <span class="equipment-tag">Beaker</span>
                        <span class="equipment-tag">Indicator</span>
                    </div>
                </div>
                <div class="experiment-item">
                    <div class="experiment-title">Cell Division</div>
                    <div>Biology 101 - Dr. Cruz</div>
                    <div class="experiment-date">Due: March 21, 2024</div>
                    <div style="margin-top: 8px;">
                        <span class="equipment-tag">Microscope</span>
                        <span class="equipment-tag">Slides</span>
                        <span class="equipment-tag">Stain</span>
                    </div>
                </div>
                <div class="experiment-item">
                    <div class="experiment-title">Statistical Analysis</div>
                    <div>Mathematics - Dr. Tan</div>
                    <div class="experiment-date">Due: March 23, 2024</div>
                    <div style="margin-top: 8px;">
                        <span class="equipment-tag">Calculator</span>
                        <span class="equipment-tag">Software</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="facilities-grid">
                ...
                <div class="facility-card">
                    ...
                    <ul class="facility-features">
                        <li><i class="fas fa-flask"></i> Chemistry Lab</li>
                        <li><i class="fas fa-microscope"></i> Biology Lab</li>
                        <li><i class="fas fa-atom"></i> Physics Lab</li>
                    </ul>
                </div>
